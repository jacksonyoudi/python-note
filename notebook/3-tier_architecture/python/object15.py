...
class RectAngle(Shape):
    def __init__(self, startPoint, w, h, **kwargs):
        ...
        super(RectAngle, self).__init__(
            [startPoint, startPoint + Point(w, 0), startPoint + Point(w, h), startPoint + Point(0, h)], **kwargs)
...
class Circle(Shape):
    def __init__(self, center_p, radius, **kwargs):
        ...
        for i in xrange(N_circle):
            points_list.append(center_p + Point(radius * math.cos(2.0 * math.pi * i / N_circle),
                                                radius * math.sin(2.0 * math.pi * i / N_circle)))
